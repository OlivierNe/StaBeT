$(function () {
    ...
    function onEditBtnClick() {
        ...
        if ($tds.find("input#Bedrijf").is(":checked") ) {
            $currentRow.find("td[data-name='Bedrijf']").after('<td width="120px;" id="wachtwoordTd"><input class="form-control text-box single-line password valid" id="Wachtwoord" name="Wachtwoord" type="password" placeholder="wachtwoord"></td>');
        }
        $tds.find("input#Bedrijf").change(function () {
            if ($(this).is(":checked")) {
                $currentRow.find("td[data-name='Bedrijf']").after('<td width="120px;" id="wachtwoordTd"><input class="form-control text-box single-line password valid" id="Wachtwoord" name="Wachtwoord" type="password" placeholder="wachtwoord"></td>');
            } else {
                $("#wachtwoordTd").remove();
    ...
    //<input class="form-control text-box single-line password valid" id="Wachtwoord" name="Wachtwoord" type="password">
